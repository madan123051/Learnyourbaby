...
export const CATEGORIES: Category[] = [
  { name: 'Animals', emoji: '🐾', color: 'bg-warning',   description: 'Learn animals in 3 languages!' },
  { name: 'Fruits',  emoji: '🍎', color: 'bg-error',     description: 'Learn fruit names!'             },
  { name: 'Colors',  emoji: '🎨', color: 'bg-secondary', description: 'World of colors!'               },
  { name: 'Numbers', emoji: '🔢', color: 'bg-info',      description: 'Learn counting!'                },
  { name: 'Body',    emoji: '🧍', color: 'bg-success',   description: 'Body parts!'                    },
  { name: 'Food',    emoji: '🍱', color: 'bg-primary',   description: 'Food & drinks!'                 },
];
